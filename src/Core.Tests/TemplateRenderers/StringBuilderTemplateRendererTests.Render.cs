...
public partial class StringBuilderTemplateRendererTests
{
    public class Render : StringBuilderTemplateRendererTests
    {
        ...
        public void Throws_When_GenerationEnvironment_Is_Not_StringBuilder()
        {
            // Arrange
            var sut = CreateSut();
            var request = new RenderTemplateRequest(new TestData.Template(_ => { }), DefaultFilename, new Mock<IMultipleContentBuilder>().Object);
        ...
        public void Renders_Template_Correctly()
        {
            ...
            var request = new RenderTemplateRequest(template, DefaultFilename, generationEnvironment);
