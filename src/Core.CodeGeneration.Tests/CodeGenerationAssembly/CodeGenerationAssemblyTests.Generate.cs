...
public partial class CodeGenerationAssemblyTests
{
    public class Generate : CodeGenerationAssemblyTests
    {
        ...
        public void Runs_All_CodeGenerators_In_Specified_Assembly()
        {
            ...
            // Act
            sut.Generate(new CodeGenerationAssemblySettings(TestData.BasePath, TestData.GetAssemblyName(), currentDirectory: TestData.BasePath), GenerationEnvironmentMock.Object);
        ...
        public void Runs_Filtered_CodeGenerators_In_Specified_Assembly()
        {
            ...
            // Act
            sut.Generate(new CodeGenerationAssemblySettings(TestData.BasePath, TestData.GetAssemblyName(), currentDirectory: TestData.BasePath, classNameFilter: new[] { typeof(MyGeneratorProvider).FullName! }), GenerationEnvironmentMock.Object);
        ...
        public void Runs_Filtered_CodeGenerators_In_Specified_Assembly_No_Matches()
        {
            ...
            // Act
            sut.Generate(new CodeGenerationAssemblySettings(TestData.BasePath, TestData.GetAssemblyName(), currentDirectory: TestData.BasePath, classNameFilter: new[] { "WrongName" }), GenerationEnvironmentMock.Object);
