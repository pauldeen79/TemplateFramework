...
public class TemplateParameterWrapper : ITemplateParameter
{
    ...
    public string Name
    {
        get
        {
            ...
            if (prop is null)
            {
                throw new NotSupportedException("TemplateParameter does not have a property called Name");
            }
    ...
    public Type Type
    {
        get
        {
            ...
            if (prop is null)
            {
                throw new NotSupportedException("TemplateParameter does not have a property called Type");
            }

            var result = prop.GetValue(_instance) as Type;
            if (result is null)
            {
                throw new NotSupportedException("Type property did not return a Type instance");
            }
